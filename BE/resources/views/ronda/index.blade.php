                ...
                <form method="POST" action="{{ route('ronda.store') }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="hari" placeholder="Contoh: Sabtu Malam" required class="w-full border-slate-100 rounded-2xl bg-slate-50 text-xs py-3 px-4 font-semibold">
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="regu" placeholder="Regu Mawar 1" required class="w-full border-slate-100 rounded-2xl bg-slate-50 text-xs py-3 px-4 font-semibold">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase mb-1">Pos Ronda</label>
                        <input type="text" name="pos_ronda" value="Pos Ronda Utama RT 01" required class="w-full border-slate-100 rounded-2xl bg-slate-50 text-xs py-3 px-4 font-semibold">
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase mb-1">Nama-nama Warga Petugas Piket</label>
                        <textarea name="anggota_warga" placeholder="Pak Budi, Pak Joko, Pak Hendra..." required class="w-full border-slate-100 rounded-2xl bg-slate-50 text-xs py-3 px-4 font-semibold"></textarea>
                    </div>
                    <div class="pt-2 flex justify-end gap-2">
                        ...
                        <button type="submit" class="px-6 py-2.5 bg-indigo-600 text-white rounded-xl font-black text-xs uppercase shadow-md">Simpan Jadwal</button>
                    </div>
                </form>
            </div>
        </div>
