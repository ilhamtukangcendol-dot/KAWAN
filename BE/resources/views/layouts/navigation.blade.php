<nav x-data="{ open: false }" class="flex flex-col h-screen bg-slate-900 border-r border-slate-800 w-72 fixed left-0 top-0 z-50 text-white">
    ...
    <div class="flex-grow px-3 py-4 overflow-y-auto custom-scrollbar space-y-5">
